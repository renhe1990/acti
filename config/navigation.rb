...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    #
    primary.item :home, '课程安排', root_url
    primary.item :courses, '我的课程', courses_url, highlights_on: %r(/courses)
    primary.item :public_courses, '公共课程', public_courses_url, highlights_on: %r(/public_courses)
